            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20">
                  ...
                  <span className="text-sm font-semibold text-primary uppercase tracking-wide">Latest Gaming News</span>
                </div>
                
                <h1 className="text-5xl md:text-7xl font-black leading-tight">
                  Level Up Your
                  <span className="block gradient-gaming-text text-glow">Gaming Experience</span>
                </h1>
                
                <p className="text-xl text-muted-foreground leading-relaxed">
                  Dive into the ultimate gaming hub with exclusive reviews, breaking news, and expert guides for the hottest titles.
                </p>
                
                <div className="flex flex-wrap gap-4">
                  <Link to="/posts">
                    <Button size="lg" className="gradient-gaming font-bold uppercase tracking-wide glow-effect hover:glow-effect-strong text-lg px-8 py-6">
                      Explore News
                      <ArrowRight className="ml-2 h-5 w-5" />
                    </Button>
                  </Link>
                  <Link to="/games">
                    <Button size="lg" variant="outline" className="border-2 border-primary/50 hover:bg-primary/10 font-bold uppercase tracking-wide text-lg px-8 py-6">
                      Browse Games
                    </Button>
                  </Link>
                </div>
                ...
                <Link to={`/post/${featuredPost.slug}`}>
                  <div className="relative aspect-[4/5] rounded-2xl overflow-hidden border-2 border-primary/20 glow-effect hover:glow-effect-strong transition-all group">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 space-y-3">
                      <Badge className="gradient-gaming font-semibold">Featured</Badge>
                      <h3 className="text-2xl font-bold text-white line-clamp-2">{featuredPost.title}</h3>
                      <p className="text-sm text-gray-300 line-clamp-2">{featuredPost.excerpt}</p>
                    </div>
                  </div>
                </Link>
              </div>
          ...
          <div className="container">
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                <p className="text-muted-foreground">Most popular titles right now</p>
              </div>
              <Link to="/games">
                ...
                <Link key={game.id} to={`/game/${game.slug}`}>
                  <div className="group relative aspect-[3/4] rounded-xl overflow-hidden border border-primary/20 hover:border-primary/50 transition-all glow-effect hover:glow-effect-strong">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge className="gradient-gaming font-bold text-lg px-3 py-1">#{index + 1}</Badge>
                    </div>
          ...
          <div className="container">
            <div className="flex items-center justify-between mb-10">
              <div>
                ...
                <p className="text-muted-foreground">Stay updated with the gaming world</p>
              </div>
              <Link to="/posts">
                <Button variant="ghost" className="group">
                  View All
