          ...
          <CardContent>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
              <div className='text-center p-4 rounded-lg bg-background/50 border border-primary/10'>
                ...
                <h3 className='font-semibold'>{t('dashboard.manageUsers')}</h3>
              ...
              <div className='text-center p-4 rounded-lg bg-background/50 border border-primary/10'>
                ...
                <h3 className='font-semibold'>{t('dashboard.manageGames')}</h3>
                <p className='text-sm text-muted-foreground'>
              ...
              <div className='text-center p-4 rounded-lg bg-background/50 border border-primary/10'>
                ...
                <h3 className='font-semibold'>{t('dashboard.managePosts')}</h3>
                <p className='text-sm text-muted-foreground'>
