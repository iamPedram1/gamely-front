...
import type { Zod } from "zod" // Declared the Zod variable here
...
import { generateEmailSchema, generateFileSchema, generateStringSchema } from "@/validations/common"
...
export default function ProfilePage() {
  ...
  const updateProfile = useUpdateProfileMutation({
    onSuccess: (_, vars) => {
      if ("password" in vars && typeof vars.password === "string" && vars.password.length > 0) logout(routes.login)
    },
  })
    ...
    return (
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 container py-40 items-center justify-center">
          ...
          <h2 className="text-4xl font-normal mb-4 text-center">Unauthorized</h2>
                ...
                <CardContent className="space-y-6">
                    ...
                    <Controller
                      ...
                      render={({ field }) => (
                        <Avatar className="h-24 w-24 border-4 border-primary/20">
                          <AvatarImage
                            src={field.value instanceof File ? URL.createObjectURL(field.value) : field.value?.url}
                          />
                  ...
                  <div className="space-y-2">
                    ...
                    <Controller
                      control={control}
                      name="name"
                      render={({ field }) => <Input id="name" placeholder="Enter your name" required {...field} />}
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Controller
                      ...
                      name="email"
                      render={({ field }) => (
                        <Input id="email" type="email" placeholder="your@email.com" required {...field} />
                      )}
                    />
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Controller
                      ...
                      name="bio"
                      render={({ field }) => (
                        <Textarea id="bio" placeholder="Tell others about yourself..." rows={5} {...field} />
                      )}
                    />
